import { version as version$1, ref, watchEffect, watch, getCurrentInstance as getCurrentInstance$1, hasInjectionContext, inject as inject$1, toRaw, isRef, isReactive, toRef, createVNode, mergeProps, Transition, toRefs, shallowRef, computed, nextTick, provide, onScopeDispose, withDirectives, vShow, Fragment, resolveDirective, reactive, onUnmounted, createTextVNode, capitalize, h, defineComponent as defineComponent$1, unref, shallowReactive, Suspense, camelize, readonly, TransitionGroup, Text, resolveDynamicComponent, effectScope, warn, Teleport, cloneVNode, withModifiers, toDisplayString, vModelText, useSSRContext, createApp, markRaw, isVNode, Comment, getCurrentScope, defineAsyncComponent, onErrorCaptured, onServerPrefetch, isReadonly, isShallow, withCtx } from 'file:///Users/hjohns/workspace/kurrawong/ogc-building-block-api/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/hjohns/workspace/kurrawong/ogc-building-block-api/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file:///Users/hjohns/workspace/kurrawong/ogc-building-block-api/node_modules/hookable/dist/index.mjs';
import { getContext } from 'file:///Users/hjohns/workspace/kurrawong/ogc-building-block-api/node_modules/unctx/dist/index.mjs';
import { getActiveHead } from 'file:///Users/hjohns/workspace/kurrawong/ogc-building-block-api/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin, composableNames } from 'file:///Users/hjohns/workspace/kurrawong/ogc-building-block-api/node_modules/@unhead/shared/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/hjohns/workspace/kurrawong/ogc-building-block-api/node_modules/vue-router/dist/vue-router.node.mjs';
import { createError as createError$1, sanitizeStatusCode } from 'file:///Users/hjohns/workspace/kurrawong/ogc-building-block-api/node_modules/h3/dist/index.mjs';
import { withQuery, hasProtocol, parseURL, isScriptProtocol, joinURL } from 'file:///Users/hjohns/workspace/kurrawong/ogc-building-block-api/node_modules/ufo/dist/index.mjs';
import { defu } from 'file:///Users/hjohns/workspace/kurrawong/ogc-building-block-api/node_modules/defu/dist/defu.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///Users/hjohns/workspace/kurrawong/ogc-building-block-api/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./nuxt/about-0fbe2475.mjs').then((m) => m.default || m)
  },
  {
    name: "catalogs-id-collections-collectionId",
    path: "/catalogs/:id()/collections/:collectionId()",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./nuxt/index-402903a3.mjs').then((m) => m.default || m)
  },
  {
    name: "catalogs-id-collections-collectionId-items-itemId",
    path: "/catalogs/:id()/collections/:collectionId()/items/:itemId()",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./nuxt/index-867d2f70.mjs').then((m) => m.default || m)
  },
  {
    name: "catalogs-id-collections-collectionId-items",
    path: "/catalogs/:id()/collections/:collectionId()/items",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./nuxt/index-9a6e1fce.mjs').then((m) => m.default || m)
  },
  {
    name: "catalogs-id-collections",
    path: "/catalogs/:id()/collections",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./nuxt/index-55a6c064.mjs').then((m) => m.default || m)
  },
  {
    name: "catalogs-id",
    path: "/catalogs/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./nuxt/index-e72cce7b.mjs').then((m) => m.default || m)
  },
  {
    name: "catalogs",
    path: "/catalogs",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./nuxt/index-3efb165b.mjs').then((m) => m.default || m)
  },
  {
    name: "debug",
    path: "/debug",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./nuxt/debug-ef1a5826.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./nuxt/index-bf15fc6a.mjs').then((m) => m.default || m)
  },
  {
    name: "sparql",
    path: "/sparql",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./nuxt/sparql-64db4c6f.mjs').then((m) => m.default || m)
  },
  {
    name: "test",
    path: "/test",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./nuxt/test-a0e6f645.mjs').then((m) => m.default || m)
  }
];
...
function createDate(options, locale) {
  ...
  const instance = reactive(typeof date2.adapter === "function" ? new date2.adapter({
    locale: ((_a2 = date2.locale) == null ? void 0 : _a2[locale.current.value]) ?? locale.current.value,
...
function useDate() {
  const instance = inject$1(DateAdapterSymbol);
  if (!instance)
...
const VDatePickerMonth = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const year = useProxiedModel(props, "year", void 0, (v) => {
      let date2 = adapter.date(_model.value);
      if (v != null)
        date2 = adapter.setYear(date2, Number(v));
      return adapter.startOfYear(date2);
    }, (v) => adapter.getYear(v));
    const month = useProxiedModel(props, "month", void 0, (v) => {
      let date2 = adapter.date(_model.value);
      if (v != null)
        date2 = adapter.setMonth(date2, Number(v));
      date2 = adapter.setYear(date2, adapter.getYear(year.value));
      return date2;
    ...
    function isDisabled(value) {
      ...
      if (props.min && adapter.isAfter(props.min, date2))
        return true;
      if (props.max && adapter.isAfter(date2, props.max))
        return true;
...
defineComponent$1({
  ...
  setup: setupForUseMeta((_, { slots }) => {
    var _a2, _b, _c;
    return {
      title: ((_c = (_b = (_a2 = slots.default) == null ? void 0 : _a2.call(slots)) == null ? void 0 : _b[0]) == null ? void 0 : _c.children) || null
    };
  })
});
defineComponent$1({
...
const layouts = {
  default: () => import('./nuxt/default-48bcdfa5.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./nuxt/error-404-7e271fa9.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./nuxt/error-500-6b1fb824.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./nuxt/island-renderer-28e4f834.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { _export_sfc as _, useRouter$1 as a, useRuntimeConfig as b, createError as c, navigateTo as d, entry$1 as default, useRoute as e, defineStore as f, nuxtLinkDefaults as n, storeToRefs as s, useHead as u };
