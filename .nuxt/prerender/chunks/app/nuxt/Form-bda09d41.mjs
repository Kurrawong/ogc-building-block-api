...
import { useSSRContext, defineComponent, ref, watch, unref, resolveComponent, mergeProps, withCtx, createTextVNode, createVNode, resolveDynamicComponent, toDisplayString, openBlock, createBlock, createCommentVNode, Fragment, renderList } from 'file:///Users/hjohns/workspace/kurrawong/ogc-building-block-api/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs, ssrInterpolate, ssrRenderList, ssrRenderStyle, ssrRenderAttr, ssrRenderClass } from 'file:///Users/hjohns/workspace/kurrawong/ogc-building-block-api/node_modules/vue/server-renderer/index.mjs';
...
import { a as _sfc_main$4 } from './config-a8038391.mjs';
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                ssrRenderList(unref(fields), (field) => {
                  var _a, _b;
                  _push2(`<tr data-v-6ce81e14${_scopeId}><th style="${ssrRenderStyle({ "white-space": "nowrap" })}" data-v-6ce81e14${_scopeId}>${ssrInterpolate(_ctx.form.formHeaders[field].label)} \xA0<a${ssrRenderAttr("href", _ctx.form.formHeaders[field].iri)}${ssrRenderAttr("title", field)} data-v-6ce81e14${_scopeId}>`);
                    ...
                    (openBlock(true), createBlock(Fragment, null, renderList(unref(fields), (field) => {
                      ...
                      return openBlock(), createBlock("tr", null, [
                        createVNode("th", { style: { "white-space": "nowrap" } }, [
                          createTextVNode(toDisplayString(_ctx.form.formHeaders[field].label) + " \xA0", 1),
                          createVNode("a", {
...
//# sourceMappingURL=Form-bda09d41.mjs.map
