...
import { _ as _sfc_main$1 } from './List-4d6990f3.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_CommonBreadcrumbs, {
        items: [
          ...
          { title: unref(tpl)("{{!bc}}Collections"), to: `/catalogs/${id.value}/..`, disabled: true }
        ]
      }, null, _parent));
      _push(ssrRenderComponent(_component_ContainersList, {
        ...
        fields: ["skos:prefLabel", "dcterms:identifier", "iri"]
      }, null, _parent));
      _push(`<!--]-->`);
    };
  }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/catalogs/[id]/collections/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-55a6c064.mjs.map
