    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_CommonBreadcrumbs, {
        items: [
          ...
          { title: unref(tpl)("{{!bc}}Items"), to: `/catalogs/${id.value}/collections/${collectionId.value}/items` },
          { title: `${itemId.value}`, to: unref(route).path, disabled: true }
        ]
      }, null, _parent));
      _push(ssrRenderComponent(_component_ContainersForm, {
        "header-title": unref(tpl)("{{ header.label }} resource"),
        "form-title": "{{ fields.rdfs:label }}",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/catalogs/[id]/collections/[collectionId]/items/[itemId]/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-867d2f70.mjs.map
