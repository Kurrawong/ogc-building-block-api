import { a as useRouter, _ as _export_sfc, s as storeToRefs, e as useRoute } from "../server.mjs";
import { defineComponent, resolveComponent, mergeProps, unref, withCtx, createTextVNode, toDisplayString, createVNode, openBlock, createBlock, Fragment, renderList, createCommentVNode, useSSRContext, ref, watch } from "vue";
...
import { a as _sfc_main$2 } from "./config-a8038391.js";
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              ssrRenderList(unref(fields), (field) => {
                _push2(`<th style="${ssrRenderStyle({ "white-space": "nowrap" })}" data-v-f59d8ffd${_scopeId}>${ssrInterpolate(field in _ctx.list.listHeaders ? _ctx.list.listHeaders[field].label : `${field} missing`)}  `);
                  ...
                  createVNode("tr", null, [
                    (openBlock(true), createBlock(Fragment, null, renderList(unref(fields), (field) => {
                      return openBlock(), createBlock("th", { style: { "white-space": "nowrap" } }, [
                        createTextVNode(toDisplayString(field in _ctx.list.listHeaders ? _ctx.list.listHeaders[field].label : `${field} missing`) + "  ", 1),
...
const List_vue_vue_type_style_index_0_scoped_f59d8ffd_lang = "";
...
//# sourceMappingURL=List-4d6990f3.js.map
